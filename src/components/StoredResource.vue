<template>
 <base-card v-for="item in data" :key="item.id" class="pb-2 grid grid-flow-col  grid-cols-2 ">
 <template #storedResource>
    <div class="col-span-4">
            ...
            <v-card-subtitle class="text-orange-800 font-semibold">
